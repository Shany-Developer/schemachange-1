  ...
  for (directory_path, directory_names, file_names) in os.walk(root_directory):
    for file_name in file_names:
      ...
      if script_type == 'R':
        ...
        script['script_description'] = os.path.join(os.path.relpath(directory_path,root_directory), description_script_name_parts.group(3).replace('_', ' ')).replace('\\','-').capitalize()
      else:
